...
Private Declare Function GradientFill Lib "msimg32" (ByVal hdc As Long, ByVal pVertex As Long, ByVal dwNumVertex As Long, ByVal pMesh As Long, ByVal dwNumMesh As Long, ByVal dwMode As Long) As Long
...
Private zBlend As Byte '0=SOLID,255=Clear 'NOT ACTUALLY USED IT APPEARS
